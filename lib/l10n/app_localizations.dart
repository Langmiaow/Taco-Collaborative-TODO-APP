...
abstract class AppLocalizations {
  ...
  /// No description provided for @addContentHint.
  ///
  /// In en, this message translates to:
  /// **'Add content'**
  String get addContentHint;
  ...
  /// No description provided for @editRemarkHint.
  ///
  /// In en, this message translates to:
  /// **'Edit remark'**
  String get editRemarkHint;
  ...
  ///
  /// In en, this message translates to:
  /// **'Use the code below to add this task'**
  String get shareHint;

  /// No description provided for @addByCodeTitle.
  ///
  /// In en, this message translates to:
  /// **'Add by code'**
  String get addByCodeTitle;

  /// No description provided for @addByCodeHint.
  ///
  /// In en, this message translates to:
  /// **'Enter the code below to add a task'**
  String get addByCodeHint;
  ...
  /// No description provided for @retryInput.
  ///
  /// In en, this message translates to:
  /// **'Try again'**
  String get retryInput;
}
